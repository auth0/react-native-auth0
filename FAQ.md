...
9. [How can I prevent the autogenerated redirect_uri from breaking if the applicationId has mixed cases in it on Android?](#-how-can-i-prevent-the-autogenerated-redirect_uri-from-breaking-if-the-applicationId-has-mixed-cases-in-it-on-android)
