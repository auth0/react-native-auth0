 ...
 * In a browser, clients are cached by config signature so remounts reuse the same
 * instance (avoiding duplicate refresh exchanges); a config change yields a fresh client.
 */
