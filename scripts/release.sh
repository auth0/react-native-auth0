...
SINGLE_QUOTED_REPO_NAME="'$REPO_NAME'"

echo "module.exports = { name: $SINGLE_QUOTED_REPO_NAME, version: $SINGLE_QUOTED_NEW_VERSION };" > src/networking/telemetry.js
...
echo "Creating tag $NEW_V_VERSION"
