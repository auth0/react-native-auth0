...
Pass `useLegacyAuthentication: true` to use the legacy authentication method (`SFSafariViewController` instead of `SFAuthenticationSession`). Typically used in non SSO applications. iOS only.
