...
| **Passkeys**                               |                      |               | ---                                                                                                                                                                      |
| `signupWithPasskey()`                      |          ✅          |      ❌       | **Native-only.** Registers a new passkey and returns Auth0 credentials. Requires iOS 16.6+ or Android API 28+.                                                           |
| `signinWithPasskey()`                      |          ✅          |      ❌       | **Native-only.** Authenticates with an existing passkey and returns Auth0 credentials. Requires iOS 16.6+ or Android API 28+.                                            |
