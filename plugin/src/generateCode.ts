//The official recommendation is to fork this file - https://github.com/expo/expo/issues/20418#issuecomment-1441211822
//which can be found here - https://github.com/expo/expo/blob/main/packages/@expo/config-plugins/src/utils/generateCode.ts
