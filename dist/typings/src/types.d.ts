...
export declare type CamelizeString<ObjectProperty extends string> =
  ObjectProperty extends `${infer F}_${infer R}`
    ? `${F}${Capitalize<CamelizeString<R>>}`
    : ObjectProperty;
export declare type Camelize<GenericObject> = {
...
export declare type Credentials = Camelize<RawCredentials>;
export declare type User = Camelize<RawUser>;
...
export declare type MultifactorChallengeResponse =
